...
sub_health_h = st.number_input("Salud", min_value=0.0, max_value=1)
sub_commitment_h = st.number_input("Compromiso", min_value=0.0, max_value=1)
sub_perceptiveness_h = st.number_input("Perceptividad", min_value=0.0, max_value=1)
sub_dexterity_h = st.number_input("Destreza", min_value=0.0, max_value=1)
sub_sociality_h = st.number_input("Socialidad", min_value=0.0, max_value=1)
sub_goodness_h = st.number_input("Benevolencia", min_value=0.0, max_value=1)
sub_strength_h = st.number_input("Fortaleza", min_value=0.0, max_value=1)
sub_openmindedness_h = st.number_input("Mentalidad Abierta", min_value=0.0, max_value=1)
